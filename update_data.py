...
def analyze_pro(category, photo_id):
    prompt = f"分析{category}领域ID为{photo_id}的图片。请从设计逻辑、视觉锚点、材质细节、批判性提升四个维度深度客观拆解。输出JSON，包含id, category, imageUrl, title, brief, detailedAnalysis, suggestion。imageUrl统一使用https://i0.wp.com/images.unsplash.com/photo-{photo_id}?w=1000&q=80"
    try:
